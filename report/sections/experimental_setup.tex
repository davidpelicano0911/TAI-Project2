...
\subsection{External Generalisation Dataset}
To assess generalisation, we also tested all-rounder on the dataset
of Quintas-Torra et al.~\cite{quintas2026}, consisting of 225 raw
astronomical images from five telescopes (INT, JKT, LCO, TJO, WHT)
with dimensions ranging from $510\times765$ to $4200\times2154$ pixels
and sensor types different from those in the benchmark corpus.
No codec parameters were retuned for this dataset.
